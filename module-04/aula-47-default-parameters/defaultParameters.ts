...
// ==> Exemplo 03
function exibirNome(nome: string, sobrenome = 'Silvera') {
  return nome + ' ' + sobrenome;
}

const resultado_1 = exibirNome('Cristian');
const resultado_2 = exibirNome('Cristian', undefined);
// const resultado_3 = exibirNome('Glaucia', 'de Souza', 'Senhorita');
const resultado_4 = exibirNome('Cristian', 'Silvera');
